      ...
      >
        <form className={stylesForm.form} data-id="av-form">
          ...
          <p className={stylesForm.desc} data-id="av-desc">
            Abbiamo inviato un&#39;email di conferma all&#39;account che hai
            usato per iscriverti, segui le istruzioni indicate nell&#39;email!{" "}
            <br /> Se non vedi l&#39;email controlla nello spam!
          </p>
          <div
            data-id="av-resend"
          ...
          {message && (
            <p data-id="av-msg" className={stylesForm.message}>
              {message}
            </p>
          )}
        </form>
